module objects {
    export abstract class TextureAtlas extends createjs.Sprite {
        // Variables
        ...
        public flipOffsetX: number;

        // Constructor
        constructor(textureAtlas: createjs.SpriteSheet, imageString:string, scaleX: number, scaleY: number, flipOffsetX: number) {
